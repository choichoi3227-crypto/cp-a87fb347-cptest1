...
const ghRepo  = (e) => e.GH_REPO   || "cp-a87fb347-cptest1";
const ghToken = (e) => e.GITHUB_TOKEN || "";
const ghPages = (e) => e.GH_PAGES_URL || "https://choichoi3227-crypto.github.io/cp-a87fb347-cptest1";
const siteUrl = (e) => e.SITE_URL  || "https://cp-a87fb347-wp.choichoi3227.workers.dev";
...
async function ghRaw(env, filePath, ttl = 300) {
  ...
  if (!o || !r || o === "choichoi3227-crypto" || r === "cp-a87fb347-cptest1") return null;
  try {
...
export default {
  async fetch(req, env, ctx) {
    ...
    if (pagesBase && pagesBase !== "https://choichoi3227-crypto.github.io/cp-a87fb347-cptest1") {
      try {
